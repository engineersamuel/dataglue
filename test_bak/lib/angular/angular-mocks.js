 ...
 *
 * <pre>
 *   dataGlueDev = angular.module('dataGlueDev', ['dataGlue', 'ngMockE2E']);
 *   dataGlueDev.run(function($httpBackend) {
...
>>>>>>> 8dca056... docs(mocks): fix typos
   ...
   * <pre>
   *
   *   angular.module('dataGluelicationModule', [])
   *       .value('mode', 'app')
   ...
   *     beforeEach(module('dataGluelicationModule'));
   *
   *
