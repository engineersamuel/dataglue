...
(function() {
  define(["angular", "services", "jquery", "nv", "moment", "bubble"], function(angular, services, $, nv, moment, Bubble) {
    ...
    }).directive("d3Visualization", function($timeout) {
      return {
        restrict: "E",
        scope: {
          val: "=",
        ...
        link: function(scope, element, attrs) {
          ...
          $(window).resize(function() {
            ...
            if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
              ...
              return $("#graph_container svg").height(innerHeight);
            }
          });
          if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
            return $timeout((function() {
