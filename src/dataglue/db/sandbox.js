...
(function() {
  var Db, assert, dataSetCache, dbLogic, logger, mongodb, pj, prettyjson, sandbox, settings, utils, zlib, _;
    ...
    return mongodb.connect(mongourl, function(err, conn) {
      if (err) {
        ...
        return conn.command({
          ...
          filteredOutput = _.filter((output != null ? output['databases'] : void 0) || [], function(item) {
            return !_.find(['local', 'dataglue', 'unified-monthly_one_day_closed_link_report', 'unified-salesforce-jobs'], function(excludedSchema) {
  ...
  sandbox.test_substring = function() {
    ...
    item = {
      name: 'unified-salesforce.system.indexes'
    };
